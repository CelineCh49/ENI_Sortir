...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        for($i=0;$i<90;$i++)
        {
            ...
            $participant->setMotPasse($this->passwordHasher->hashPassword($participant,'azerty'));
        ...
        for ($i = 0; $i < 5; $i++) {
            ...
            $sortieCreee->setInfosSortie($faker->paragraph(1));
            $sortieCreee->setDateHeureDebut($randomDate);
            ...
            $sortieCreee->setNbInscriptionsMax($faker->numberBetween(1, 20));
        ...
        for ($i = 0; $i < 15; $i++) {
            ...
            $sortieOuverte->setInfosSortie($faker->paragraph(1));
            $sortieOuverte->setDateHeureDebut($randomDate);
            $sortieOuverte->setDuree($faker->numberBetween(60, 240));
            $dateLimiteInscription = (clone $randomDate)->modify('-1 day');
            $sortieOuverte->setDateLimiteInscription($dateLimiteInscription);
            $sortieOuverte->setNbInscriptionsMax($faker->numberBetween(1, 20));
        ...
        for ($i = 0; $i < 5; $i++) {
            ...
            $sortieCloturee->setInfosSortie($faker->paragraph(1));
            $sortieCloturee->setDateHeureDebut($randomDate);
            $sortieCloturee->setDuree($faker->numberBetween(60, 240));
            $dateLimiteInscription = (clone $randomDate)->modify('-1 day');
            $sortieCloturee->setDateLimiteInscription($dateLimiteInscription);
            $sortieCloturee->setNbInscriptionsMax($faker->numberBetween(1, 20));
        ...
        for ($i = 0; $i < 5; $i++) {
            ...
            $sortieEnCours->setInfosSortie($faker->paragraph(1));
            $sortieEnCours->setDateHeureDebut($randomDate);
            $sortieEnCours->setDuree($faker->numberBetween(60, 240));
            $dateLimiteInscription = (clone $randomDate)->modify('-1 day');
            $sortieEnCours->setDateLimiteInscription($dateLimiteInscription);
            $sortieEnCours->setNbInscriptionsMax($faker->numberBetween(1, 20));
        ...
        for ($i = 0; $i < 5; $i++) {
            ...
            $sortiePassee->setInfosSortie($faker->paragraph(1));
            $sortiePassee->setDateHeureDebut($randomDate);
            $sortiePassee->setDuree($faker->numberBetween(60, 240));
            $dateLimiteInscription = (clone $randomDate)->modify('-1 day');
            $sortiePassee->setDateLimiteInscription($dateLimiteInscription);
            $sortiePassee->setNbInscriptionsMax($faker->numberBetween(1, 20));
        ...
        for ($i = 0; $i < 5; $i++) {
            ...
            $sortieArchivee->setInfosSortie($faker->paragraph(1));
            $sortieArchivee->setDateHeureDebut($randomDate);
            $sortieArchivee->setDuree($faker->numberBetween(60, 240));
            $dateLimiteInscription = (clone $randomDate)->modify('-1 day');
            $sortieArchivee->setDateLimiteInscription($dateLimiteInscription);
            $sortieArchivee->setNbInscriptionsMax($faker->numberBetween(1, 20));
            ...
            $sortieArchivee->setEtat($manager->getRepository(Etat::class)->findbyLibelle('Historisée'));
        ...
        foreach ($sorties as $sortie) {
            ...
            if ($sortie->getEtat()->getLibelle() !== 'Créée') {
                ...
                $nombreParticipantsMax = $sortie->getNbInscriptionsMax()-1;
        ...
        // Création d'un participant Inactif pour la désactivation de compte
        $participantInactif = new Participant();
        $participantInactif->setNom('Inactif');
        $participantInactif->setPrenom('Participant');
        $participantInactif->setMotPasse($this->passwordHasher->hashPassword($participantInactif,'azerty'));
        $participantInactif->setActif(false);
        $participantInactif->setCampus($faker->randomElement($campus));
        $participantInactif->setEmail('testanonyme@test.com');
        $participantInactif->setPseudo('Inactif');
        $participantInactif->setTelephone('0600000000');
        $manager->persist($participantInactif);
        $participantsInactifArray[] = $participantInactif;

        // Affichage du nombre de participants enregistrés
        $nombreParticipantInactif = count($participantsInactifArray);
        dump($nombreParticipantInactif . " participant Inactif a été créé");
        ...
        $participantAdmin->setMotPasse($this->passwordHasher->hashPassword($participantAdmin,'azerty'));
